...
let v1 = new Veiculo_1.Veiculo(`Moto`, `PCX`, `Honda`);
...
let pf = new PessoaFisica_1.PessoaFisica(`Larissa Iaquimitro Ravanelli`, `123.321.231-01`);
...
let l1 = new Livro_1.Livro(`Lady Killers`, `Dark Side`, `Tori Telfer`);
...
let r1 = new Residencia_1.Residencia(`Casa`, `8`, true);
...
let pj = new PessoaJuridica_1.PessoaJuridica(`Larissa`, `Lari`, `00.123.321/0001-12`);
...
console.log(`Garagem: ${r1.getGaragem()}`);
console.log(``);
let p1 = new Pessoa_1.Pessoa(`Larissa Iaquimitro Ravanelli`, 2006);
